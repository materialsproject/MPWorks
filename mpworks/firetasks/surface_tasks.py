...
class WriteSurfVaspInput(FireTaskBase):
    ...
    def run_task(self, fw_spec):
        ...
        mplb_u.write_input(orient_u_cell, '%s_ucell_k%s_%s' %element %k_product %miller_index)
        ...
        mplb_s.write_input(slab_cell, '%s_scell_k%s_%s' %element %k_product %miller_index)
