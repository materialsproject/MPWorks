    ...
    def run_task(self, fw_spec):
        ...
        if ucell_entry.data['state'] != 'successful':
            ...
            for slab in slab_list:
                ...
                # Some parameters may not be inherited from bulk, ie. IBRION is always initially
                # 2, NBANDS is turned off in slab calculations to avoid band related errors,
                # ISIF = 2 to prevent lattice relaxation in the slab.

                incar = ucell_entry.data["final_incar"]
